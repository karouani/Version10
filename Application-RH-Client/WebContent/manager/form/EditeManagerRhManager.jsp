	...
	<div class="span12">
		<div class="box gradient">
			...
			<div class="content noPad clearfix">
				...
				<form action="UpdateManagerRh" method="POST" class="form-horizontal"
					id="wizzard-form">
					...
					<div id="wizard-validation" class="swMain">
						<ul>
							...
							<li><a href="#step-3"> <label class="stepNumber">3</label>
									<span class="stepDesc"> col détailles </span>
							</a></li>
						...
						<div id="step-1">
							<div class="span12">
								...
								<div class="form-row row-fluid">
									<div class="span12">
										<div class="row-fluid">
											<label class="form-label span3" for="prenom">Prénom :</label>
									...
									<div class="span12">
										<div class="row-fluid">
											<label class="form-label span3" for="email">Email :</label> <input
												class="span9" id="email" name="email" type="text"
									...
									<div class="span12">
										<div class="row-fluid">
											<label class="form-label span3" for="abreviation">Abreviation
												...
												type="text"
												value='<s:property value="col.abreviation" />' />
										</div>
									</div>
								</div>
						...
						<div id="step-2">
							...
							<div class="form-row row-fluid afficher">
								<div class="span12">
									<div class="row-fluid">
										<label class="form-label span3" for="moisBAP">mois BAP
											:</label> <input class="span9" id="moisBAP" name="moisBAP"
										...
										<div class="row-fluid afficher" id="technologie">
											...
											<div class="span7 controls"
												...
												<input class="span6 text desctechno" type="text"
													placeholder="Technologie" /> <input
													class="span6 text comp" type="text"
													placeholder="Comp&eacute;tences" /> <select
												...
												<div class="row-fluid">
													...
													<div class="span9 controls">
														<select id="profile" name="profile">
															<s:if
																test="col.getProfil().getRole() == 'AmbassadeurRH'">
															...
															<s:if
																...
																<option value="ResponsableProduction" selected="selected">Responsable
																	de production</option>
																<option value="ManagerAgence">Manager d'agence</option>
															</s:if>
	
															<s:if
																test="col.getProfil().getRole() == 'ManagerAgence'">
																<option value="AmbassadeurRH">Ambassadeur RH</option>
																<option value="ResponsableProduction">Responsable
																	de production</option>
					...
					<!-- End wizard-validation -->
				</form>
			</div>
			<!-- End content noPad clearfix -->
		</div>
		<!-- End box gradient -->
	</div>
	<!-- End .span12 -->
