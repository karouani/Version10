	...
	<div class="span12">
		<div class="box gradient">
			...
			<div class="content noPad clearfix">
				...
				<form action="AjouterCollaborateur" method="POST" class="form-horizontal"
					id="wizzard-form">
					<!-- Smart Wizard -->
						...
						<div id="step-1">
							<div class="span12">
								<div class="form-row row-fluid">
									<div class="span12">
										<div class="row-fluid">
											<s:if test="%{nouveauCollaborateur != null}">
												<div class="alert alert-error">
													<a href="" class="close" data-dismiss="alert">X</a>
													<p>
														<s:property value="nouveauCollaborateur" />
													</p>
												</div>
											</s:if>
									...
									<div class="span12">
										<div class="row-fluid" id="diplome">
											<label class="form-label span3" for="diplome">Diplôme
												1 :</label> <input class="span9" type="text" name="ecole" />
											<div class="span7 controls"
												...
												<input type="text" name="promotion" maxlength="9"
